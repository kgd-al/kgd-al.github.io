 ...
 \itm{Contact}{}{%
  \centering\begin{tabular}[t]{c@{ }m{.35\textwidth}c@{ }m{.3\textwidth}}
   ...
   \faHome & \UnivVUShort
     ...
     & \includegraphics{misc/academicons_orcid}
       & \href{https://orcid.org/0009-0002-6033-3555}{0009-0002-6033-3555}
  \end{tabular}
 }
 \\[-.5em]
...
\begin{sect}{Highlights}
 \itm{\En{Research}\Fr{Recherche}}{}{%
  \large\emph{\En{Artificial Life: Morphology, Cognition \& Interaction}}
 }
 \\[-.5em]
 ...
 \itm{}{\En{Output}}{%
  ...
  7 international workshops short papers (\emph{ALife, ECAL, AAAI})\\
...
%  \\[.5em]
 ...
 \itm{\En{Teaching}}{}{9 years ($\sim$800 hours)}
 \\[-.5em]
 
 \itm{}{Computer\\ Science}{
  Learning Machines, NeuroEvolution \\
  Bachelor and Master research projects \\
...
\begin{sect}{Research}
 ...
 \itm{Reinforcement Learning}{}{
  Complementing Neuro-Evolutionary approaches with Reinforcement-based learning for more robust agents.
 }
 \ritm{amaze}{AMaze}{AMaze}{GodinDubois2025c,GodinDubois2025d}{
  Benchmark generator for lightweight sighted agents. Meant as a fast prototyping platform for Reinforcement Learning and NeuroEvolutionary algorithms. \\
  \sref{https://github.com/kgd-al/amaze}{AMaze}
 }
 \ritm{sharpie}{SHARPIE}{SHARPIE}{Aydin2025b,Aydin2025a}{
  Collaborative Hybrid Intelligence project aiming to provide the new standard for interactive experiments in Reinforcement Learning settings. \\
  \sref{https://github.com/hybrid-intelligence/SHARPIE}{SHARPIE}
 }
 \\[.5em]
 ...
 \ritm{ann_vfmri_colored}{Virtual fMRI}{IRMf virtuelle}{GodinDubois2021a,GodinDubois2023,GodinDubois2024b}{
  ...
  \sref{https://github.com/kgd-al/ABrain}{ABrain}
 }
%  \ritm{mew}{Species dynamics}{Dynamiques d'esp\`eces}{GodinDubois2019b}{}
 ...
 \itm{}{Machine Learning}{
  ...
  \di Stable baselines 3, PyTorch
 }
 \\[-.5em]
 \itm{}{Physics simulators}{
  \di Approximate: Bullet3, Box2D \\
  \di Exact: MuJoCo
 }
%  \\[-.5em]
\end{sect}
...
\begin{sect}{\teachings}
 \itm{\En{Postdoc}\Fr{Projets M2}}{2023-2024}{
  ...
  \di Master and Bachelor thesis supervision \ritm{$\sim$200h}\\
 }
 \\[-.5em]
...
\begin{sect}{Outreach}
 \itm{Reviewer}{Since 2023}{
  \di Artificial Life (ALife) program comitee member \\
  \di IEEE Transactions on Evolutionary Computation \\
